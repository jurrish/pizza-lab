...
// //
// // // storesArray = [ballard, firstHill, internationalDistrict, southLakeUnion, , ravenna];
...
iDistrict.pushHourlyData((new HourlyData('11:00 am', 0, 4, 0, 4)));
iDistrict.pushHourlyData((new HourlyData('12:00 pm', 0, 7, 0, 4)));
iDistrict.pushHourlyData((new HourlyData('1:00 pm', 0, 7, 0, 4)));
iDistrict.pushHourlyData((new HourlyData('2:00 pm', 0, 7, 0, 4)));
iDistrict.pushHourlyData((new HourlyData('3:00 pm', 2, 15, 1, 4)));
iDistrict.pushHourlyData((new HourlyData('4:00 pm', 2, 15, 1, 4)));
iDistrict.pushHourlyData((new HourlyData('5:00 pm', 2, 15, 1, 4)));
iDistrict.pushHourlyData((new HourlyData('6:00 pm', 10, 26, 4, 6)));
iDistrict.pushHourlyData((new HourlyData('7:00 pm', 10, 26, 4, 6)));
iDistrict.pushHourlyData((new HourlyData('8:00 pm', 10, 26, 4, 6)));
iDistrict.pushHourlyData((new HourlyData('9:00 pm', 8, 22, 7, 15)));
iDistrict.pushHourlyData((new HourlyData('10:00 pm', 8, 22, 7, 15)));
iDistrict.pushHourlyData((new HourlyData('11:00 pm', 8, 22, 7, 15)));
iDistrict.pushHourlyData((new HourlyData('12:00 am', 0, 2, 2, 8)));
iDistrict.pushHourlyData((new HourlyData('1:00 am', 0, 2, 2, 8)));
iDistrict.pushHourlyData((new HourlyData('2:00 am', 0, 2, 2, 8)));
